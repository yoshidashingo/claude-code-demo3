        ...
        case 'ADD_ITEM':
            {
                ...
                if (existingItem) {
                    const newItems = state.items.map((item)=>item.product.id === action.product.id ? {
                            ...item,
        ...
        case 'UPDATE_QUANTITY':
            {
                ...
                const newItems = state.items.map((item)=>item.product.id === action.productId ? {
                        ...item,
...
function CartProvider({ children }) {
    ...
    const removeItem = (productId)=>dispatch({
            type: 'REMOVE_ITEM',
            productId
        });
    const updateQuantity = (productId, quantity)=>dispatch({
...
function Header() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "sticky top-0 z-40 bg-[var(--background)] border-b shadow-sm",
...
function ToastContainer() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: toasts.map((toast)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["classNames"])('px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 animate-slide-in', toast.type === 'success' && 'bg-[var(--success)] text-white', toast.type === 'error' && 'bg-[var(--error)] text-white', toast.type === 'info' && 'bg-[var(--primary)] text-white'),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89b23b65._.js.map